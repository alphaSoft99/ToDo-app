...
class ItemEditCategory extends StatefulWidget {
  final Category category;
  final Function changePos;
  final int pos;
  ItemEditCategory({this.category, this.changePos, this.pos});

  @override
  _ItemEditCategoryState createState() => _ItemEditCategoryState();
}

class _ItemEditCategoryState extends State<ItemEditCategory>
  ...
  void initState() {
    ...
    _dotTopPositionedAnimation =
        Tween<double>(begin: 15, end: 0).animate(_controller);
    _textColorAnimation =
